...
namespace SmartCommander.Views
{
    public partial class MainWindow : ReactiveWindow<MainWindowViewModel>
    {
        ...
        public MainWindow() 
        {
            ...
            this.WhenActivated(d => d(ViewModel!.LeftFileViewModel.ShowViewerDialog.RegisterHandler(DoShowDialogAsync<ViewerViewModel, ListerWindow>)));
            this.WhenActivated(d => d(ViewModel!.RightFileViewModel.ShowViewerDialog.RegisterHandler(DoShowDialogAsync<ViewerViewModel, ListerWindow>)));
